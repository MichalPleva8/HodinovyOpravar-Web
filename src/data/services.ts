...
export const services: Service[] = [
  {
    ...
    title: 'Voda & kúrenie',
    icon: 'wrench',
    description: 'Opravy vodovodov, inštalácie, výmena batérií a radiátorov. Riešime úniky vody, upchané odpady a problémy s kúrením.',
    slug: 'voda-kurenie',
  ...
  },
  {
    ...
    title: 'Elektrika',
    icon: 'zap',
    description: 'Elektroinštalácie, opravy elektrospotrebičov a montáže. Profesionálne riešenie elektrických problémov.',
    slug: 'elektrika',
  ...
  },
  {
    ...
    icon: 'car',
    description: 'Základné opravy a údržba motorových vozidiel a bicyklov. Výmeny pneumatík, olejov a bežná servisná práca.',
  ...
  },
  {
    ...
    icon: 'paint-brush',
    description: 'Interiérové a exteriérové maľovanie stien, stropov a povrchov. Príprava podkladu a profesionálne natieranie.',
    slug: 'malovanie',
  ...
  },
  {
    ...
    icon: 'package',
    description: 'Montáž a zostavenie nábytku všetkých typov. IKEA, JYSK a ďalší nábytok rýchlo a profesionálne.',
  ...
  },
  {
    ...
    icon: 'hammer',
    description: 'Obkladanie, dlažby, opravy stien a iné stavebné práce. Od menších opráv po rekonštrukcie.',
    slug: 'stavebne-prace',
  ...
  },
  {
    ...
    icon: 'home',
    description: 'Všeobecné opravy a údržba v domácnosti. Riešenie rôznych problémov a drobných porúch.',
  ...
  },
  {
    ...
    icon: 'flower',
    description: 'Údržba záhrady, kosenie trávnikov, strihanie živých plotov a ďalšie záhradnícke služby.',
    slug: 'zahradne-prace',
